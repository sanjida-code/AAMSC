...
<form action="login_staff_php.php" method="post">
<div style= "background-color:#3377ff; padding:3px; margin-left:0px; margin-top:0px; width:100%">
<h2 style="text-align: center; font-size: 40px; color:white;">Login Form for Staff</h2>
</div>
  ...
  <div class="container">
	...
	<br>
	<a href="staff_forgetpassword.php">Forget Password</a>
	<b>
	</select>	
