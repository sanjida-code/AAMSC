...
<section style="height:600px; width:100%;" id = "section2">
...
$conn=mysqli_connect($servername , $serveruser , $serverpass , $DBname ) ;
 ...
 $sql= "select * from admission_circular";
...
while($row = mysqli_fetch_array($result))
  ...
  echo  "<td>"?> <img src="<?php echo  $row["image"];?>" style="width:800px; height:300px;"><?php echo "</td>";
  echo "    ";
  echo "</tr>";
  }
echo "</table>";
