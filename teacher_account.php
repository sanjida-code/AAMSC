...
?>
  ...
  <td> 
       <form action = "teacher_account_edit.php" method = "post">
  ...
  <td>
     <form action = "teacher_account_delete.php" method = "post">
...
?>
		...
		<form action = "teacher_account_add.php" method = "post" style="padding-top:30px;">
