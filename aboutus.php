...
<li class="active"><a href="#"><i class="fa fa-user" aria-hidden="true"></i>About Us</a>
    <div class= "sub-manu-1">
        <ul>
             <li><a href="#">Messege From Chairman</a></li>
             <li><a href="#">Messege From Principal</a></li>
...
<li><a href="#"><i class="fa fa-plus-square" aria-hidden="true"></i>Admission</a>
      <div class= "sub-manu-1">
        <ul>
        <li><a href="#"></a>Admission Circuler</li>
...
<li><a href="#"><i class="fa fa-phone" aria-hidden="true"></i>Contect</a></li>
