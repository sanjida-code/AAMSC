...
<nav>
<div Class="logo">
<a href =""><img src="logo.jpg" style="height:100px; width:150px;"></a>
...
<div class= "sub-manu-1">
<ul>
<li><a href="login_teacher.php">Teacher</a></li>
...
while($row = mysqli_fetch_array($result))
  ...
  echo  "<td>"?> <img src="<?php echo  $row["image"];?>" style="width:800px; height:1000px;"><?php echo "</td>";
  echo "    ";
  echo "</tr>";
  }
echo "</table>";
  ...
  echo "</br>";
	...
	?>
	     ...
	     <h3> আনোয়ার আলী মেমোরিয়াল স্কুল এন্ড কলেজে</h3>
		 </center>
	 </div>
