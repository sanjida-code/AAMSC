...
<center>
<form  method="post" action="register_student_php.php" style="heigth:100%;" >  
<h1>Register Form For Student</h1>
<hr>
...
<tr>
  ...
  <span class="error">* <?php echo $nameErr;?></span>
   ...
   <td>Birth ID Number: </td><td><input type="number" name="id" value=" ">
  </td>
<tr>
  <tr>
