...
<style>
body {font-family: Arial, Helvetica, sans-serif;background-color: lightblue; margin:0px;}
form {
...
<form action="login_student_php.php" method="post">
<div style= "background-color:#3377ff; padding:3px; margin-left:0px; margin-top:0px; width:100%">
<h2 style="text-align: center; font-size: 40px; color:white;">Login Form for Student</h2>
</div>
  ...
  <div class="container">
	...
	<br>
	<a href ="student_forgetpassword.php">Forget Password</a>
	<br>
	</select>	
