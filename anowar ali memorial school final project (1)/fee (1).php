...
<li><a href="#"><i class="fa fa-user" aria-hidden="true"></i>About Us</a>
    <div class= "sub-manu-1">
        <ul>
             <li><a href="message_chairman.php">Messege From Chairman</a></li>
...
<li class="active"><a href="fee.php"><i class="fa fa-money" aria-hidden="true"></i>Fee/Payment</a></li>
...
<div class="row">
	 ...
	 <div class="event-col">
<img src="bkash.jpg" style="height:800px; width:750px; border-radius: 2px;">
</div>
	 <div class="event-col" style="margin:auto;">
	     <h3 style="color:#ff0080">For online payment/fees</h3>
		 <h3 style="color:#ff0080">We have only one way is Bkash. We recived our fees.</h3>
		 <h3 style="color:#ff0080">Bkash No: 01864172286</h3>
		 <h3 style="color:#ff0080">OR</h3>
		 <h3 style="color:#ff0080">Contect School Account</h3> 
		 <h3 style="color:#ff0080">Help-line: 01864172286</h3>
