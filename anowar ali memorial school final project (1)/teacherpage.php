...
<li class="active"><a href="#"><i class="fa fa-unlock-alt" aria-hidden="true"></i>Portals</a>
<div class= "sub-manu-1">
<ul>
...
<div class="teacherpage">
	...
	<a href="register_teacher.php">Registration</a><br><br><br>
	<h1>OR</h1><br><br><br>
	 <a href="login_teacher.php">Log In</a>
